...
namespace Igor.Lua
{
    ...
    public abstract class SerializationTag : ISerializationTag
    {
        ...
        public static readonly ISerializationTag Json = new JsonTag();

        public class BoolTag : SerializationTag
        {
            public override string ToString() => "igor.Bool";
        ...
        {
            public override string ToString() => "igor.Number";
        ...
        {
            public override string ToString() => "igor.String";

            public override ISerializationTag Instantiate(IDictionary<GenericArgument, ISerializationTag> args) => this;
        }

        public class JsonTag : SerializationTag
        {
            public override string ToString() => "igor.Json";
        ...
        public class List : SerializationTag
        {
            ...
            public override string ToString() => $"igor.List.generic_instance({ItemType})";
        ...
        public class Dict : SerializationTag
        {
            ...
            public override string ToString() => $"igor.Dict.generic_instance({KeyType}, {ValueType})";
        ...
        public class Optional : SerializationTag
        {
            ...
            public override string ToString() => $"igor.Optional.generic_instance({ItemType})";
        ...
        public class Var : SerializationTag
        {
            ...
            public override string ToString() => Arg.luaName;
